...
protoc -I=./ --go_out=plugins=grpc:./ --go_opt=paths=source_relative --proto_path=./  ./menu/v1/*.proto admin/v1/*.proto

protoc -I=./ --go_out=plugins=grpc:./ --go_opt=paths=source_relative --proto_path=./  ./admin/v1/*.proto
```

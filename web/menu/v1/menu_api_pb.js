...
goog.exportSymbol('proto.menu.v1.CountriesRequest', null, global);
goog.exportSymbol('proto.menu.v1.CountriesResponse', null, global);
 ...
 * @constructor
 */
proto.menu.v1.CountriesResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.menu.v1.CountriesResponse.repeatedFields_, null);
};
goog.inherits(proto.menu.v1.CountriesResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.menu.v1.CountriesResponse.displayName = 'proto.menu.v1.CountriesResponse';
}
 ...
 * @const
 */
proto.menu.v1.CountriesResponse.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.menu.v1.CountriesResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.menu.v1.CountriesResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.menu.v1.CountriesResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.menu.v1.CountriesResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    countriesList: jspb.Message.toObjectList(msg.getCountriesList(),
    menu_v1_menu_pb.Country.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.menu.v1.CountriesResponse}
 */
proto.menu.v1.CountriesResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.menu.v1.CountriesResponse;
  return proto.menu.v1.CountriesResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.menu.v1.CountriesResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.menu.v1.CountriesResponse}
 */
proto.menu.v1.CountriesResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new menu_v1_menu_pb.Country;
      reader.readMessage(value,menu_v1_menu_pb.Country.deserializeBinaryFromReader);
 ...
 * @return {!Uint8Array}
 */
proto.menu.v1.CountriesResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.menu.v1.CountriesResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.menu.v1.CountriesResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.menu.v1.CountriesResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      menu_v1_menu_pb.Country.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Array<!proto.menu.v1.Country>}
 */
proto.menu.v1.CountriesResponse.prototype.getCountriesList = function() {
  return /** @type{!Array<!proto.menu.v1.Country>} */ (
    jspb.Message.getRepeatedWrapperField(this, menu_v1_menu_pb.Country, 1));
};


/**
 * @param {!Array<!proto.menu.v1.Country>} value
 * @return {!proto.menu.v1.CountriesResponse} returns this
*/
proto.menu.v1.CountriesResponse.prototype.setCountriesList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.menu.v1.Country=} opt_value
 * @param {number=} opt_index
 * @return {!proto.menu.v1.Country}
 */
proto.menu.v1.CountriesResponse.prototype.addCountries = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.menu.v1.Country, opt_index);
};
 ...
 * @return {!proto.menu.v1.CountriesResponse} returns this
 */
proto.menu.v1.CountriesResponse.prototype.clearCountriesList = function() {

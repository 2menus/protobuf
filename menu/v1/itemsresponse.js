...
goog.provide('proto.menu.v1.ItemsResponse');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.menu.v1.Item');
...
proto.menu.v1.ItemsResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.menu.v1.Item.toObject, includeInstance)
  };
...
proto.menu.v1.ItemsResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.menu.v1.Item;
      reader.readMessage(value,proto.menu.v1.Item.deserializeBinaryFromReader);
...
proto.menu.v1.ItemsResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.menu.v1.Item.serializeBinaryToWriter
    );
  }
};
...
proto.menu.v1.ItemsResponse.prototype.getItemListList = function() {
  return /** @type{!Array<!proto.menu.v1.Item>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.menu.v1.Item, 1));
};
